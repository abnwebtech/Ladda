...
function Spinner(opts) {
  this.opts = merge(opts || {}, Spinner.defaults, defaults);
}
  ...
  if (!useCssAnimations) {
    ...
    (function anim() {
      ...
      for (var j = 0; j < o.lines; j++) {
        ...
        opacity(el, j * o.direction + start, alpha, o);
      }
...
function lines(el, o) {
  ...
  for (; i < o.lines; i++) {
    ...
    if (o.shadow) ins(seg, css(fill('#000', '0 0 4px #000', o, i), {top: '2px'}));
    ins(el, ins(seg, fill(getColor(o.color, i), '0 0 1px rgba(0,0,0,.1)', o, i)));
  }

  return el;
}

function fill(color, shadow, o, i) {
  return css(createEl(), {
    position: 'absolute',
